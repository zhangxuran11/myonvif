...
pushd gsoap-2.8
./configure --prefix=$(pwd)/install  --with-openssl=/usr/lib/ssl/
make -j
make install
...
sed -i '106i\#import "wsse.h"' /tmp/onvif.h
${GSOAP_DIR}/bin/soapcpp2 -2 -C -L -x -I ${GSOAP_DIR}/share/gsoap/import:${GSOAP_DIR}/share/gsoap/ /tmp/onvif.h
